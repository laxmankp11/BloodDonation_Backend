...
<!-- <li><a class="nav-link" href="{{ route('register') }}">Add Sub Admin</a></li> -->
<li><a class href="{{ route('list_sub_admin') }}"><img src="{{ asset('img/menu-icon/2.svg') }}" alt>Manage Sub Admin</a></li>
<li><a class href="{{ route('list_pages') }}"><img src="{{ asset('img/menu-icon/2.svg') }}" alt>Manage Pages</a></li>
