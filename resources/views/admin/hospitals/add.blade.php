...
<div class="col-12">
                ...
                <form method="post" enctype="multipart/form-data">
                   ...
                   <div class="mb-3">
                        <label for="website" class="form-label">Website</label>
                          <input type="text" class="exampleFormControlInput1 form-control @error('website') is-invalid @enderror" id="website" name="website" value="{{ old('website') }}">
                    ...
                    <div class="mb-3">
                        <label for="hospital_partners_reason" class="form-label">Why does your hospital want to partner with our blood donation application?</label>
                          <textarea rows="4" class="exampleFormControlInput1 form-control @error('hospital_partners_reason') is-invalid @enderror" id="hospital_partners_reason" name="hospital_partners_reason" value="{{ old('hospital_partners_reason') }}"></textarea>
                    ...
                    <div class="mb-3">
                        <label for="requirement_from_partenrship" class="form-label">Any specific requirements or expectations from the partnership? [Brief Explanation]</label>
                          <textarea rows="4" class="exampleFormControlInput1 form-control @error('requirement_from_partenrship') is-invalid @enderror" id="requirement_from_partenrship" name="requirement_from_partenrship" value="{{ old('requirement_from_partenrship') }}"></textarea>
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="zipcode" class="form-label">Zipcode</label>
                          <input type="text" class="exampleFormControlInput1 form-control @error('zipcode') is-invalid @enderror" id="zipcode" name="zipcode" value="{{ old('zipcode') }}">
                    ...
                    <div class="mb-3">
                        <label for="contact_person_name" class="form-label">Contact Person Name</label>
                          <input type="text" class="exampleFormControlInput1 form-control @error('contact_person_name') is-invalid @enderror" id="contact_person_name" name="contact_person_name" value="{{ old('contact_person_name') }}">
                    ...
                    <div class="mb-3">
                        <label for="contact_person_phone_no" class="form-label">Phone No</label>
                          <input type="text" class="exampleFormControlInput1 form-control @error('contact_person_phone_no') is-invalid @enderror" id="contact_person_phone_no" name="contact_person_phone_no" value="{{ old('contact_person_phone_no') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control @error('contact_person_email') is-invalid @enderror" id="contact_person_email" name="contact_person_email" value="{{ old('contact_person_email') }}">
                    ...
                    <div class="mb-3">
                        <label for="contact_person_position" class="form-label">Contact Person Name</label>
                          <input type="text" class="exampleFormControlInput1 form-control @error('contact_person_position') is-invalid @enderror" id="contact_person_position" name="contact_person_position" value="{{ old('contact_person_position') }}">
                     ...
                     <div class="mb-3">
                        <label for="license_no" class="form-label">Contact Person Licence No</label>
                          <input type="text" class="exampleFormControlInput1 form-control @error('license_no') is-invalid @enderror" id="license_no" name="license_no" value="{{ old('license_no') }}">
                     ...
                     <div class="mb-3">
                        <label for="blood_donation_units_monthly" class="form-label">Number of Blood Donation Units Collected Monthly: [Average Monthly Units]</label>
                          <input type="text" class="exampleFormControlInput1 form-control @error('blood_donation_units_monthly') is-invalid @enderror" id="blood_donation_units_monthly" name="blood_donation_units_monthly" value="{{ old('blood_donation_units_monthly') }}">
 ...
 <div class="mb-3">
                          ...
                          <input type="checkbox" name="terms_agreement" class="select-permission select-all-module-permissions select-all-client-permissions" id="select_all" data-class="select-all-client-permissions" value="1" required> I agree to comply with all applicable laws and regulations regarding blood donation.
                    ...
                    <div class="mb-3">
                          ...
                          <input type="checkbox" name="cooperate_agree" class="select-permission select-all-module-permissions select-all-client-permissions" id="select_all" data-class="select-all-client-permissions" value="1" required>I agree to cooperate with the blood donation application team for the successful implementation of this partnership.
