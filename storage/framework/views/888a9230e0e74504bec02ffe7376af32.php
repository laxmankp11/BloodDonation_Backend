...
unset($__errorArgs, $__bag); ?>" id="title" name="title" value="<?php echo e($data[0]->title); ?>">
                    ...
                    <div class="mb-3">
                        <label for="url_route" class="form-label">Url Route</label>
...
unset($__errorArgs, $__bag); ?>" id="url_route" name="url_route" value="<?php echo e($data[0]->url_route); ?>">
...
<?php echo $__env->make('admin.include.admin_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/BloodDonation_Backend/resources/views/admin/pages/edit_page.blade.php ENDPATH**/ ?>