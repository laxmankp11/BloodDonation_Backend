...
<script src="<?php echo e(asset('vendors/swiper_slider/js/swiper.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('vendors/gijgo/gijgo.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('vendors/apex_chart/apexcharts.js')); ?>"></script>

<script src="<?php echo e(asset('js/custom.js')); ?>"></script>

<script src="<?php echo e(asset('js/active_chart.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/apex_chart/radial_active.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/apex_chart/stackbar.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/apex_chart/area_chart.js')); ?>"></script>

<script src="<?php echo e(asset('vendors/apex_chart/bar_active_1.js')); ?>"></script>
<script src="<?php echo e(asset('vendors/chartjs/chartjs_active.js')); ?>"></script>

</body>

<!-- Mirrored from demo.dashboardpack.com/finance-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 10:31:11 GMT -->
</html><?php /**PATH /var/www/html/BloodDonation_Backend/resources/views/admin/include/admin_footer.blade.php ENDPATH**/ ?>